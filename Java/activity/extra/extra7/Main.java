...
public class Main implements ActionListener {
    ...
    Label lab2 = new Label("Valor de compra", 150, 50, 10, 103);
    Input in1 = new Input(200,20,142,122);
    Window win = new Window(450,450,"Atividade - 7");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == b1.btm){
            ...
            lab1.getLabel().setText("O valor das prestações em 5x ficará R$"+prestacao);
        }
    }
}
